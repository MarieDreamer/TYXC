...
}, i = require("../../../utils/util.js"), s = require("../../../utils/config.js"), n = require("../../../utils/reg.js"), r = getApp(), l = require("../../../utils/api.js"), d = require("../../../utils/common.js"), u = [], c = require("../../../utils/tripledes.js"), p = wx.createInnerAudioContext(), g = require("../../../utils/albumsjump.js").albumsjump, h = require("../../../utils/hotActive.js").hotActive, m = void 0, f = void 0, w = void 0, v = 0, S = 0, b = 0, I = 0;
...
Page((e = {
    ...
    showTimeAxis: function() {},
    showEventAxis: function() {},
    prevent: function() {
        this.setData({
            fromlast: 1
        });
    ...
    onShow: function() {
        ...
        if (n.flashSaleShowSwitch(), n.setData({
            ...
            var d = r.upObj;
            if (!d.picarr || 0 == d.picarr.length) return void console.log("获取上传的参数出错");
    ...
    uploadpicasync: function(t, e, a, o) {
        ...
        if (0 == e.length) wx.request({
            ...
            success: function(t) {
                ...
                if (h(wx.getStorageSync("userid"), a.mainIdStr, "upload"), s.getCsTimeData(), r.isUp = !1, 
    ...
    uploadpicasyncEvetn: function(t, e, a, o) {
        var s = this;
        if (0 == e.length) wx.request({
            url: l.getUrl("YinianProject/family/addIncident"),
            data: {
                userid: wx.getStorageSync("userid"),
                groupid: a.mainIdStr,
                content: a.content,
    ...
    uppic: function(t, e, a, o, i, s) {
        var n = this, l = e[0], d = l.lastIndexOf("."), c = new Date().getTime() + "" + parseInt(1e8 * Math.random() + 1e8) + l.substring(d);
        wx.uploadFile({
            url: "https://upload.qiniup.com",
            filePath: l,
            name: "file",
    ...
    getAlbumInformation: function(t) {
        var e = this, a = c.encryptByDESModeCBC(t.userid), o = c.encryptByDESModeCBC(e.groupid), s = this.port ? this.port : "", n = this.fromUserID ? this.fromUserID : 0, l = e.zj, d = e.comeuserid;
        i.wxreq({
            ...
            if (2 != a.code) if (1012 == a.code) wx.showModal({
                ...
                d != t.userid && "0" != a.data[0].picNum && "yes" == t.isnew && e.setData({
                    showcomeuserModel: !0,
                ...
                }), 1 == s.advertisementsShow && e.getBusiness(), 30 == s.groupNewType && (e.getLoversAuth(), 
    ...
    addmember: function(t) {
        ...
        if (e.groupid) {
            if (this.loadImgStateNo = !0, this.setData({
                ...
                var n = this.groupid, l = this.data.userid, d = this.data.ablumInfo.gcreator;
                i.countLoversOperation("addmember", n, l, d);
            }
            var u = e.groupid || 0;
    ...
    toEditPhotosDelete: function(t) {
        ...
        var o = t.currentTarget.dataset.photosource, s = this.data.eventlist[this.a].list[0].picList, n = this.data.eventlist[this.a].list[0].eMain, l = 4 == n ? "video" : "pic", d = this.tepEid;
        if ("photosync" == o) {
            if (0 == this.data.ablumInfo.inBlackList) return void wx.showModal({
                title: "提示",
                content: "由于您先前操作已违反规定，已被限制操作，如有疑问可联系微信客服yiniankefu",
            ...
            if ("delete" != o) return;
            if (1 == n || 2 == n) return void this.delete_event(d);
            this.loadImgStateNo = !0;
        }
    ...
    recomment: function(t) {
        if (void 0 != t.target.dataset.commentindex) {
            var e = this, o = t.target.dataset.commentindex, s = t.currentTarget.dataset.dataindex.split(","), n = a(s, 2), l = n[0], d = n[1], u = this.data.eventlist[l].list[d].comments[o], c = u.commentUser.userid, p = u.commentUser.unickname, g = t.currentTarget.dataset.eid;
    ...
    sendcomment: function(t) {
        var e = t.detail.formId, a = t.detail.value.content, o = this.data.userid, s = this.commentEid, l = this.commentedUserid, d = this.commentedname;
                    ...
                    wx.removeStorageSync("uploadchoosedpic"), wx.setStorage({
                        ...
                        success: function() {
                            if (e.setData({
                                ...
                                var a = e.groupid;
                                if ("event" == t.currentTarget.dataset.stype) wx.navigateTo({
                                    url: "/pages/publish/pages/eventImage/eventImage?groupId=" + e.groupid + "&albumType=4"
                                }); else {
                                    var o = e.data.ablumInfo.groupNewType;
                                    wx.navigateTo({
                                        url: "/pages/publish/pages/image/image?lastPage=albumDetail&groupId=" + a + "&albumType=" + o
                                    });
                                }
                            }
                        },
    ...
    getCsTimeData: function() {
        ...
        t.isloading = !1, wx.request({
            url: l.getUrl("YinianProject/family/showTimeAxis"),
            data: {
                userid: wx.getStorageSync("userid"),
                groupid: t.groupid,
                type: "initialize",
            ...
            success: function(e) {
                if (console.log(e), 0 == e.data.code) {
                    ...
                    for (var s = 0; s < t.templatearr.length; s++) t.templatearr[s].list[0].maxPicList = t.templatearr[s].list[0].picList.length, 
                    6 == t.templatearr[s].list[0].eMain && t.templatearr[s].list[0].picList.length > 11 && t.templatearr[s].list[0].picList.splice(11, t.templatearr[s].list[0].picList.length - 11);
                    t.setData({
    ...
    enterpreview: function(t) {
        ...
        return console.log(e, a, o), console.log(i[e].list[a].picList), wx.setStorageSync("lookImgs", i[e].list[a].picList), 
    ...
    tosharepage: function(t) {
        ...
        var n = t.currentTarget.dataset.index, l = this.data.eventlist[n].list[0].picList, d = this.data.eventlist[n].list[0].eMain, u = this.data.eventlist[n].list[0].eid;
        r.sharePageUserPic = 0, wx.setStorageSync("sharePagePic", l), "object" == o(this.button) && this.button.push({
            name: "eventShare"
        }), wx.navigateTo({
    ...
    like: function(t) {
        if (console.log("点赞"), console.log(t), wx.getStorageSync("userid")) {
            var e = t.detail.formId, a = t.currentTarget.dataset.likecatagry, o = t.currentTarget.dataset.parentindex, i = t.currentTarget.dataset.childindex || 0, s = (t.currentTarget.dataset.emain, 
            t.currentTarget.dataset.eid), n = this;
            n.data.eventlist[o].list[i].likeUser = 1, n.data.eventlist[o].list[i].likeCnt = parseInt(n.data.eventlist[o].list[i].likeCnt) + 1, 
            a && (n.isLikepushId(), h(wx.getStorageSync("userid"), n.groupid, "like"), n.setData({
            ...
            success: function(e) {
                console.log(e), 0 == e.data.code ? 0 == (e = e.data).data.length ? t.setData({
                    ...
                    t.retState || (Object.assign(e, {
                        ...
                        showlibox: !1,
                        isAudioPlay: !1
                    }), e.maxPicList = e.picList.length, 6 == e.eMain && e.picList.length > 11 && e.picList.splice(11, e.picList.length - 11), 
                    t.templatearr.push({
                        month: e.euploadtime.substring(0, 7).replace("-", "."),
                        list: [ e ]
                    }));
    ...
    showPvModel: function() {
        ...
        if ("object" == o(this.button) && this.button.push({
            ...
            if (t.setData({
                ...
                var d = this.groupid, u = this.data.userid, c = this.data.ablumInfo.gcreator;
                i.countLoversOperation("loversUpBtn", d, u, c);
            }
        } else wx.showModal({
            title: "提示",
            content: "只能创建者才能上传"
    ...
    var e = this;
    if (b = t.changedTouches[0].pageX, I = t.changedTouches[0].pageY, v - b > 30) {
    ...
    e && (console.log(e), p.src = e, p.play(), this.openThisAudio(e));
}), t(e, "audioPause", function() {
    p.pause(), this.closeAllAudio();
    ...
    console.log("131:" + m.groupid), wx.navigateTo({
        url: "/pages/photowall/photowall?clickFrom=familyscoll&groupid=" + m.groupid + "&from=grouplist"
    });
    ...
    r.stat.request({
        ...
        success: function(t) {
            console.log(t), wx.hideLoading(), 0 == t.data.code ? (wx.setStorageSync("storyId", t.data.data[0].storyId), 
            wx.request({
                ...
                success: function(t) {
                    if (wx.hideLoading(), console.log(t), 0 === t.data.code) {
                        ...
                        var e = d.getCurrentPageUrlWithArgs();
                        console.log(e), wx.setStorageSync("skipUrl", e), wx.navigateTo({
                            url: "/package/stories/pages/make/makeStory?eId=" + wx.getStorageSync("storyId") + "&groupid=" + m.groupid + "&index=1&groupType=" + w
                        });
                    } else wx.showToast({
                        icon: "none",
                        title: "生成故事集失败"
    ...
    if (0 == e.length) console.log(u), i.wxreq({
        ...
        }, 2e3), n.getCsTimeData(), r.isUp = !1, r.fromUp = "") : (u.length = 0, _this.setData({
            upSteps: 3,
            showProgress: !0,
            uploadnum: 0,
            progress: 0
...
}), t(e, "toEventAxis", function() {
    var t = this.groupid;
    wx.navigateTo({
        url: "/pages/familyAlbum/eventAxis/eventAxis?groupid=" + t
    });
}), t(e, "toSport", function() {
    var t = this.groupid, e = this.data.ablumInfo.gname, a = this.data.ablumInfo.groupNewType;
    wx.navigateTo({
        url: "/package/sport/sport?groupId=" + t + "&groupName=" + e + "&groupNewType=" + a + "&fromPage=album&port=familySport"
    });
}), e));