 ...
 */
require_once(C('APPLICATION_DIR')."/Home/Widget/Alipay/lib/alipay_core.function.php");
require_once(C('APPLICATION_DIR')."/Home/Widget/Alipay/lib/alipay_rsa.function.php");
require_once(C('APPLICATION_DIR')."/Home/Widget/Alipay/lib/alipay_md5.function.php");
